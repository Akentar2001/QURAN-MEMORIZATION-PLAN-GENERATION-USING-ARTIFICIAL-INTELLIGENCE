...
student_lesson_history_df.to_csv('student_lessons_history_with_differences.csv', index=False)

print("New columns for differences have been added and saved to 'student_lessons_history_with_differences.csv'")