...
def upgrade():
    ...
    sa.Column('pages_count', sa.REAL(), autoincrement=False, nullable=True),
    sa.Column('letters_count', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    ...
    sa.Column('last_verse_recited_new_memorization', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('last_verse_recited_large_revision', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('new_memorization_letters_amount', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('new_memorization_pages_amount', sa.REAL(), autoincrement=False, nullable=True),
    sa.Column('small_revision_letters_amount', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('small_revision_pages_amount', sa.REAL(), autoincrement=False, nullable=True),
    sa.Column('large_revision_letters_amount', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('large_revision_pages_amount', sa.REAL(), autoincrement=False, nullable=True),
    sa.Column('memorization_days', sa.SMALLINT(), server_default=sa.text('5'), autoincrement=False, nullable=False),
    sa.Column('overall_rating', sa.REAL(), autoincrement=False, nullable=True),
    sa.Column('memorized_parts', sa.REAL(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('rl_last_action_new_memorization', sa.REAL(), autoincrement=False, nullable=True),
    sa.Column('rl_last_action_minor_revision', sa.REAL(), autoincrement=False, nullable=True),
    sa.Column('rl_last_action_major_revision', sa.REAL(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['student_id'], ['students.student_id'], name='students_plans_info_student_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['last_verse_recited_new_memorization'], ['verses.verse_id'], name='students_plans_info_last_verse_new_fkey'),
    sa.ForeignKeyConstraint(['last_verse_recited_large_revision'], ['verses.verse_id'], name='students_plans_info_last_verse_large_fkey'),
